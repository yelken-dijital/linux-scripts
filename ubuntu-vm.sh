...
# Modifications: performance tweaks, UI updates, additional automation steps.
...
function header_info {
  clear
  cat <<"EOF"
 __  ______     __  ____                __           ___   __________  __ __     _    ____  ___
\ \/ / __ \   / / / / /_  __  ______  / /___  __   |__ \ / ____/ __ \/ // /    | |  / /  |/  /
 \  / / / /  / / / / __ \/ / / / __ \/ __/ / / /   __/ //___ \/ / / / // /_    | | / / /|_/ / 
 / / /_/ /  / /_/ / /_/ / /_/ / / / / /_/ /_/ /   / __/____/ / /_/ /__  __/    | |/ / /  / /  
/_/_____/   \____/_.___/\__,_/_/ /_/\__/\__,_/   /____/_____/\____/  /_/       |___/_/  /_/   
...
pve_check() {
  ...
  if [[ "$PVE_VER" =~ ^9\.([0-9]+) ]]; then
    ...
    if (( MINOR > 1 )); then
        ...
        msg_error "Supported: Proxmox VE versions 9.0 and 9.1"
        exit 1
    fi
    return 0
  fi
